...
////				tputs(tigetstr("ed"), 1, ft_putchar);
////				write(1, "previous>", 9);
//////				write(1, history_line, strlen(history_line) - 2);
//			}
...
//				{
//					cursor += l;
//					temp = strdup((history_line + cursor - 1));
//					history_line[cursor - 1] = '\0';
//					strncat(history_line, str, 2048);
//					strncat(history_line, temp, 2048);
//					write(1, str, l);
//					write(1, temp, strlen(temp));
//					while (count < strlen(temp))
//					{
...
//			}
//		} while (strcmp(str, "\n") && strcmp(str, "\4")); // 004 eot
//		write(1, history_line, strlen(history_line));
//		history_line[0] = 0;
//		write(1, "\n", 1);
//		cursor = 0;
//		history[history_count] = strdup(history_line);
//		if (10 > history_count)
//			history_count++;
//	}
//	write(1, "\n", 1);
